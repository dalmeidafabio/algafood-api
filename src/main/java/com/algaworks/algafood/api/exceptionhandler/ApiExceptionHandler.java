...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
		...
		String detail = String.format("A propridade '%s' não existe. " 
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
		...
		String detail = String.format("A propridade '%s' recebeu o valor '%s' " 
	...
	public ResponseEntity<?> handleAcessoNegado (
	...
	public ResponseEntity<?> handleUncaught(Exception ex, WebRequest request){
	    ...
	    //>> Atualizado para logar o erro não tratado, após a aula de Logging.
