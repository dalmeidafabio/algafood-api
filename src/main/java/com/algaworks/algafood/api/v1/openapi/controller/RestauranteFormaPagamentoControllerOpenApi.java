...
@Tag(name = "Restaurantes - Formas de Pagamento", description = "Gerencia as Formas de Pagamento do Restaurante")public interface RestauranteFormaPagamentoControllerOpenApi {
